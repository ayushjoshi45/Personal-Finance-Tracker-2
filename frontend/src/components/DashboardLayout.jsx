...
const DashboardLayout = () => {
  ...
  return (
    <div className="dashboard-page min-h-screen flex flex-col lg:flex-row gap-6 p-4 md:p-6 relative">
      ...
      <div className="flex-1 glass-panel rounded-3xl p-4 md:p-8 overflow-y-auto max-h-[85vh] lg:max-h-[calc(100vh-3rem)] relative z-10 shadow-xl theme-content">
        <Outlet />
      </div>
    </div>
  );
